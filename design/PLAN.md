...
| Date | Commit | Summary |
|---|---|---|
| 2026-02-23 | `63ee9b7` (Phase 2 steps 1–3) | Step 1: `config/experiment.toml` + `train.py`. Step 2: `CharTokenizer` 14 tests. Step 3: `BaseLearningModel` ABC + `SimpleLM` (token emb + pos emb + FFN + weight-tied LM head), 12 tests. 64 Python tests passing, lint clean. |
