...
def main() -> None:  # noqa: C901
    ...
    metrics = train(
        ...
        generalization_filter_enabled=config.training.generalization_filter_enabled,
        generalization_filter_interval=config.training.generalization_filter_interval,
        generalization_filter_val_batches=config.training.generalization_filter_val_batches,
        generalization_filter_damping=config.training.generalization_filter_damping,
        generalization_filter_preserve_norm=config.training.generalization_filter_preserve_norm,
        tb_writer=tb_writer,
