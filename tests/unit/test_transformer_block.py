...
class TestTransformerBlock:
    ...
    def test_output_dtype_float32(self) -> None:
        ...
        block = TransformerBlock(d_model=128, num_heads=8, attention_backend="standard")
    ...
    def test_single_token_sequence(self) -> None:
        ...
        block = TransformerBlock(d_model=32, num_heads=2, attention_backend="standard")
    ...
    def test_large_batch_size(self) -> None:
        ...
        block = TransformerBlock(d_model=32, num_heads=4, attention_backend="standard")
    ...
    def test_different_d_models(self) -> None:
        ...
        for d_model, num_heads in [(32, 2), (64, 4), (128, 8)]:
            block = TransformerBlock(
                d_model=d_model, num_heads=num_heads, attention_backend="standard"
            )
    ...
    def test_dropout_applied_when_specified(self) -> None:
        ...
        block = TransformerBlock(d_model=64, num_heads=4, dropout=0.1, attention_backend="standard")
    ...
    def test_custom_expansion_ratio(self) -> None:
        ...
        block = TransformerBlock(
            d_model=64, num_heads=4, ff_expansion_ratio=2, attention_backend="standard"
        )
        x = torch.randn(1, 4, 64)
        out = block(x)
    ...
    def test_d_model_divisible_by_num_heads(self) -> None:
        ...
        with pytest.raises(AssertionError):
            TransformerBlock(d_model=63, num_heads=4, attention_backend="standard")
    ...
    def test_deterministic_with_seed(self) -> None:
        ...
        torch.manual_seed(42)
        block1 = TransformerBlock(d_model=64, num_heads=4, attention_backend="standard")
        block1.eval()
        out1 = block1(x)

        torch.manual_seed(42)
        block2 = TransformerBlock(d_model=64, num_heads=4, attention_backend="standard")
        block2.eval()
